...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://admin:itsaadmin@ascenda-exchange-rate.cq4bzcmfnjpo.us-east-1.rds.amazonaws.com/cs301_team1_ascenda'
